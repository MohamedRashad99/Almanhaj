...
class ListOfCourseSelected extends Equatable {
  final int id;
  ...
  factory ListOfCourseSelected.fromJson(Map<String, dynamic> json) {
    return ListOfCourseSelected(
        id: json["id"],
