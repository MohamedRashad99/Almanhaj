...
class ListOfNewestAddModel extends Equatable {
  final int id;
  ...
  const ListOfNewestAddModel(
      {required this.id,
      required this.xFeaturedMediaMedium,
      required this.title,
      required this.content});

  factory ListOfNewestAddModel.fromJson(Map<String, dynamic> json) {
    return ListOfNewestAddModel(
        id: json["id"],
